...
//            ->andWhere('is_home=?', VtCommonEnum::NUMBER_ONE)
    ...
    public static function getProductHome($limit)
    {
        $query = VtpProductsTable::getInstance()->createQuery()
            ->andWhere('is_active=?', VtCommonEnum::NUMBER_ONE)
            ->andWhere('is_home=?', VtCommonEnum::NUMBER_ONE)
    ...
    //Lay danh sach san pham nổi bât
    public static function getProductSpecialHome($limit)
    {
        $query = VtpProductsTable::getInstance()->createQuery()
            ->andWhere('is_active=?', VtCommonEnum::NUMBER_ONE)
            ->andWhere('is_hot=?', VtCommonEnum::NUMBER_ONE)
            ->limit($limit)
            ->orderBy('priority DESC');
        return $query;
    }
